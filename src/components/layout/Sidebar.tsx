...
const ICONS: Record<string, string> = {
  ...
  verification: 'M9 12l2 2 4-4m5.618-4.016A11.948 11.948 0 0112 3c-2.8 0-5.486.684-7.838 1.9A2 2 0 002 6.382v7.236a2 2 0 00.162.984A11.948 11.948 0 0112 21c2.8 0 5.486-.684 7.838-1.9a2 2 0 00.162-.984V6.382a2 2 0 00-.162-.984z',
...
export function Sidebar({ onNavigate }: { onNavigate?: () => void }) {
  ...
  return (
    <aside className="w-64 bg-neutral-900 text-neutral-300 flex flex-col h-full">
      <div className="px-6 py-5 flex items-center gap-2.5 border-b border-neutral-800">
        <div className="h-8 w-8 rounded-lg bg-primary-600 flex items-center justify-center">
          <svg className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
          </svg>
        </div>
        <span className="text-lg font-bold text-white tracking-tight">EduRecord</span>
      </div>
      ...
      <div className="px-4 py-4 border-t border-neutral-800 text-xs text-neutral-500">
        EduRecord v0.1.0
      </div>
    </aside>
  )
